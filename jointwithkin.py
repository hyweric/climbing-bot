...
class offsetJointKinematics:
    def __init__(self, l1, l2, l4, l5, l7, x4, y4, t1, t2): 
        self.t1 = t1
        self.t2 = t2
        self.l1 = l1
        self.l2 = l2
...
while True:
    ...
    a = 23
    b = 15
    t1, t2 = inverseKinematics(x, y, a, b)
    print("Theta 1: ", math.degrees(t1), "Theta 2: ", math.degrees(t2))
    OJK1 = offsetJointKinematics(a, 10, 10, 18, 15, 0, 5, 30, 110)
    ...
    plot.add_or_update_point('input', x, y)
    plot.add_line('p1', 'p2')
    plot.add_line('p2', 'p3')
    plot.add_line('p1', 'p4')
    plot.add_line('p4', 'p5')
